...
import WeatherHighlights from "./WeatherHighlights";
  ...
  useEffect(() => {
    ...
    const fetchLocation = async () => {
      ...
      try {// This beow is responsible for making Api call which csn take sometime to receive a response
...
console.error('Error fetching location:', error);
    ...
    fetchLocation();
    console.log('After fetch Location')
  }, []);
    ...
    <div className="mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-gray-300 rounded-lg shadow-md p-8">
          <h2 className="text-xl font-semibold mb-4 text-indigo-800">Today Highlights</h2>
          <WeatherToday weatherData={weatherData} />
      </div>
      <div className="bg-gray-300 rounded-lg shado-md p-8">
        <h2 className="text-xl font-semibold mb-4 text-indigo-800">Today Highlights</h2>
